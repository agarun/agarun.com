  ...
  return [
    {
      ...
      copy: true,
      description: 'right click to copy',
      color: '#ea4335',
    },
    {
      title: 'Resume',
      href: '/files/aaron-agarunov-resume.pdf',
      color: '#006da9',
    },
    {
      title: 'GitHub',
    ...
    {
      title: 'Spotify',
      href: 'https://open.spotify.com/user/12133715707',
      color: '#1ED760',
    },
    {
      title: 'Last.fm',
      href: 'http://last.fm/user/aeroecho',
      description: 'logs my music listening',
      color: '#d51007',
    },
    {
      title: 'WhatPulse',
    ...
    },
    {
      ...
      href: 'https://scholar.google.com/citations?user=qWCpZlMAAAAJ&hl=en',
      color: '#4d90fe',
      disabled: true,
    },
    {
      title: 'Are.na',
      href: 'https://www.are.na/aaron/channels',
      color: '#272727',
      disabled: true,
    },
  ];
